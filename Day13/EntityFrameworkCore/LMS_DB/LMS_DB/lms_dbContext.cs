...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-VF0EORP;Database='lms_db'; integrated security=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<LmsBookDetails>(entity =>
            {
                ...
                entity.HasOne(d => d.Supplier)
                    .WithMany(p => p.LmsBookDetails)
                    .HasForeignKey(d => d.SupplierId)
                    .HasConstraintName("LMS_cts41");
            });
            ...
            modelBuilder.Entity<LmsBookIssue>(entity =>
            {
                ...
                entity.HasOne(d => d.BookCodeNavigation)
                    .WithMany(p => p.LmsBookIssue)
                    .HasForeignKey(d => d.BookCode)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("LMS_BookDetail");

                entity.HasOne(d => d.FineRangeNavigation)
                    .WithMany(p => p.LmsBookIssue)
                    .HasForeignKey(d => d.FineRange)
                    .HasConstraintName("LMS_FineDetail");

                entity.HasOne(d => d.Member)
                    .WithMany(p => p.LmsBookIssue)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("LMS_Mem");
            });
